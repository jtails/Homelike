...
<script src="js/homelike/panelc.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp"></script>
<script src="js/homelike/serviciosc.js"></script>
...
<body>
 ...
 <jsp:include page="fragments/sessionc.jsp"/>
 
	<!-- Header starts -->
	<header>
		<div class="container">
			<jsp:include page="fragments/headerc.jsp"/>
		</div>
	</header>
	...
	<div class="content">
		...
		<div class="sidebar">
			...
			<ul id="nav">
				...
				<li class="open"><a href="registrogc.jsp"><i
						class="fa fa-home"></i> Datos Generales</a> 
           		</li>
           		<li class="has_sub"><a href="#"><i class="fa fa-tag"></i>
						Nuevo pedido<span class="pull-right"><i

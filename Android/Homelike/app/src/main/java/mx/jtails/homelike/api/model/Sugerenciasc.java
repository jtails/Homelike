...
/**
 * Model definition for Sugerenciasc.
 *
...
public final class Sugerenciasc extends com.google.api.client.json.GenericJson {
   ...
   */
  public Sugerenciasc setCuenta(Cuenta cuenta) {
    this.cuenta = cuenta;
    return this;
  }
   ...
   */
  public Sugerenciasc setFechaHoraSugerencia(com.google.api.client.util.DateTime fechaHoraSugerencia) {
   ...
   */
  public Sugerenciasc setIdSugerencia(java.lang.Integer idSugerencia) {
   ...
   */
  public Sugerenciasc setSugerencia(java.lang.String sugerencia) {
  ...
  /**
   * @param tsugerencia tsugerencia or {@code null} for none
   */
  public Sugerenciasc setTsugerencia(Tsugerencia tsugerencia) {
    this.tsugerencia = tsugerencia;
    return this;
  }

  @Override
  public Sugerenciasc set(String fieldName, Object value) {
    return (Sugerenciasc) super.set(fieldName, value);
  }

  @Override
  public Sugerenciasc clone() {
    return (Sugerenciasc) super.clone();
  }

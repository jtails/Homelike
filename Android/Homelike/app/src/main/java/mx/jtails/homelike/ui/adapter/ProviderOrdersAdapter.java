 ...
 */
public class ProviderOrdersAdapter extends ArrayAdapter<Pedido> {
    ...
    public ProviderOrdersAdapter(Context context, List<Pedido> orders){
        super(context, R.layout.list_item_provider_order, orders);
        this.mOrders = orders;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(view == null){
            view = LayoutInflater.from(this.getContext()).inflate(R.layout.list_item_provider_order,
                    parent, false);

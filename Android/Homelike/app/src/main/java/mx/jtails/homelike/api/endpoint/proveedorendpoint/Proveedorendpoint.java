...
public class Proveedorendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetProveedorByUser getProveedorByUser(mx.jtails.homelike.api.model.Proveedor content) throws java.io.IOException {
    GetProveedorByUser result = new GetProveedorByUser(content);
    initialize(result);
    return result;
  }

  public class GetProveedorByUser extends ProveedorendpointRequest<mx.jtails.homelike.api.model.Proveedor> {
     ...
     * @since 1.13
     */
    protected GetProveedorByUser(mx.jtails.homelike.api.model.Proveedor content) {
   ...
   * operation.
   *
   * @param content the {@link mx.jtails.homelike.api.model.Dispositivop}
   * @return the request
   */
  public InsertDispositivo insertDispositivo(mx.jtails.homelike.api.model.Dispositivop content) throws java.io.IOException {
    InsertDispositivo result = new InsertDispositivo(content);
    initialize(result);
    return result;
  }

  public class InsertDispositivo extends ProveedorendpointRequest<mx.jtails.homelike.api.model.Dispositivop> {

    private static final String REST_PATH = "dispositivop";
     ...
     * @since 1.13
     */
    protected InsertDispositivo(mx.jtails.homelike.api.model.Dispositivop content) {
      super(Proveedorendpoint.this, "POST", REST_PATH, content, mx.jtails.homelike.api.model.Dispositivop.class);
    }

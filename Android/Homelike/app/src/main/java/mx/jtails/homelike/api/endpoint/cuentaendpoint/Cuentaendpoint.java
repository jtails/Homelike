...
public class Cuentaendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.18.0-rc of the cuentaendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   *
   * This request holds the parameters needed by the cuentaendpoint server.  After setting any
   ...
   * @return the request
   */
  public DeleteDireccion deleteDireccion(java.lang.Integer idDireccion) throws java.io.IOException {
    DeleteDireccion result = new DeleteDireccion(idDireccion);
    initialize(result);
    return result;
  }
  ...
  public class DeleteDireccion extends CuentaendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected DeleteDireccion(java.lang.Integer idDireccion) {
      super(Cuentaendpoint.this, "POST", REST_PATH, null, Void.class);
      this.idDireccion = com.google.api.client.util.Preconditions.checkNotNull(idDireccion, "Required parameter idDireccion must be specified.");
    }
    ...
    public DeleteDireccion setIdDireccion(java.lang.Integer idDireccion) {
   ...
   * @return the request
   */
  public GetClienteswithPedidoByProveedor getClienteswithPedidoByProveedor(mx.jtails.homelike.api.model.Proveedor content) throws java.io.IOException {
    GetClienteswithPedidoByProveedor result = new GetClienteswithPedidoByProveedor(content);
    initialize(result);
    return result;
  }
  ...
  public class GetClienteswithPedidoByProveedor extends CuentaendpointRequest<mx.jtails.homelike.api.model.Proveedor> {
     ...
     * @since 1.13
     */
    protected GetClienteswithPedidoByProveedor(mx.jtails.homelike.api.model.Proveedor content) {
      super(Cuentaendpoint.this, "POST", REST_PATH, content, mx.jtails.homelike.api.model.Proveedor.class);
    }
   ...
   * operation.
   *
   * @param content the {@link mx.jtails.homelike.api.model.Dispositivo}
   * @return the request
   */
  public InsertDispositivo insertDispositivo(mx.jtails.homelike.api.model.Dispositivo content) throws java.io.IOException {
    InsertDispositivo result = new InsertDispositivo(content);
    initialize(result);
    return result;
  }

  public class InsertDispositivo extends CuentaendpointRequest<mx.jtails.homelike.api.model.Dispositivo> {
     ...
     * This request holds the parameters needed by the the cuentaendpoint server.  After setting any
     * optional parameters, call the {@link InsertDispositivo#execute()} method to invoke the remote
     * operation. <p> {@link InsertDispositivo#initialize(com.google.api.client.googleapis.services.Ab
     ...
     * @since 1.13
     */
    protected InsertDispositivo(mx.jtails.homelike.api.model.Dispositivo content) {
      super(Cuentaendpoint.this, "POST", REST_PATH, content, mx.jtails.homelike.api.model.Dispositivo.class);
    }
   ...
   * @return the request
   */
  public ListClientesinRange listClientesinRange(mx.jtails.homelike.api.model.Proveedor content) throws java.io.IOException {
    ListClientesinRange result = new ListClientesinRange(content);
    initialize(result);
    return result;
  }
  ...
  public class ListClientesinRange extends CuentaendpointRequest<mx.jtails.homelike.api.model.CuentaCollection> {
     ...
     * @since 1.13
     */
    protected ListClientesinRange(mx.jtails.homelike.api.model.Proveedor content) {
      super(Cuentaendpoint.this, "POST", REST_PATH, content, mx.jtails.homelike.api.model.CuentaCollection.class);
    }

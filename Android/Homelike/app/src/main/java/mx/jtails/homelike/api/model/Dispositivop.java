...
/**
 * Model definition for Dispositivop.
 *
 * <p> This is the Java data model class that specifies how to parse/serialize into the JSON that is
 * transmitted over HTTP when working with the proveedorendpoint. For a detailed explanation see:
...
public final class Dispositivop extends com.google.api.client.json.GenericJson {
   ...
   */
  public Dispositivop setEsDefault(java.lang.Integer esDefault) {
   ...
   */
  public Dispositivop setFechaHoraCreacion(com.google.api.client.util.DateTime fechaHoraCreacion) {
   ...
   */
  public Dispositivop setGcmid(java.lang.String gcmid) {
    this.gcmid = gcmid;
    return this;
  }
   ...
   */
  public Dispositivop setIdDispositivo(java.lang.Integer idDispositivo) {
   ...
   */
  public Dispositivop setImei(java.lang.String imei) {
    this.imei = imei;
    return this;
  }
   ...
   */
  public Dispositivop setModelo(java.lang.String modelo) {
    this.modelo = modelo;
    return this;
  }
   ...
   */
  public Dispositivop setPlataforma(java.lang.String plataforma) {
   ...
   */
  public Dispositivop setProveedor(Proveedor proveedor) {
   ...
   */
  public Dispositivop setTipoDispositivo(java.lang.String tipoDispositivo) {
    this.tipoDispositivo = tipoDispositivo;
    return this;
  }

  @Override
  public Dispositivop set(String fieldName, Object value) {
    return (Dispositivop) super.set(fieldName, value);
  }

  @Override
  public Dispositivop clone() {
    return (Dispositivop) super.clone();
  }

...
public class Cantidadpagoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListCantidadPago extends CantidadpagoendpointRequest<mx.jtails.provider.homelike.api.model.CollectionResponseCantidadPago> {
    ...
    protected ListCantidadPago() {
      super(Cantidadpagoendpoint.this, "GET", REST_PATH, null, mx.jtails.provider.homelike.api.model.CollectionResponseCantidadPago.class);
    }

...
package mx.jtails.provider.homelike.api.endpoint.productoendpoint;
...
public class Productoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * operation.
   *
   * @param content the {@link mx.jtails.provider.homelike.api.model.Producto}
   * @return the request
   */
  public InsertProducto insertProducto(mx.jtails.provider.homelike.api.model.Producto content) throws java.io.IOException {
    InsertProducto result = new InsertProducto(content);
    initialize(result);
    return result;
  }

  public class InsertProducto extends ProductoendpointRequest<mx.jtails.provider.homelike.api.model.Producto> {
     ...
     * @since 1.13
     */
    protected InsertProducto(mx.jtails.provider.homelike.api.model.Producto content) {
      super(Productoendpoint.this, "POST", REST_PATH, content, mx.jtails.provider.homelike.api.model.Producto.class);
    }
  ...
  public class ListAllProductosByProveedor extends ProductoendpointRequest<mx.jtails.provider.homelike.api.model.ProductoCollection> {
    ...
    protected ListAllProductosByProveedor() {
      super(Productoendpoint.this, "GET", REST_PATH, null, mx.jtails.provider.homelike.api.model.ProductoCollection.class);
    }
  ...
  public class ListProducto extends ProductoendpointRequest<mx.jtails.provider.homelike.api.model.CollectionResponseProducto> {
    ...
    protected ListProducto() {
      super(Productoendpoint.this, "GET", REST_PATH, null, mx.jtails.provider.homelike.api.model.CollectionResponseProducto.class);
    }
  ...
  public class ListProductosByProveedor extends ProductoendpointRequest<mx.jtails.provider.homelike.api.model.ProductoCollection> {

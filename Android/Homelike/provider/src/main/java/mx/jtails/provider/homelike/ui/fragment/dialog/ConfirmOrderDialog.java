package mx.jtails.provider.homelike.ui.fragment.dialog;
...
import mx.jtails.provider.homelike.request.UpdateOrderRequest;

/**
 * Created by GrzegorzFeathers on 11/26/14.
 */
public class ConfirmOrderDialog extends DialogFragment
    implements HomelikeApiResponseHandler<Pedido> {

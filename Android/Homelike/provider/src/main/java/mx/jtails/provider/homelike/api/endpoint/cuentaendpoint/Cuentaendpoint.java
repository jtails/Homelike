...
public class Cuentaendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetClienteswithPedidoByProveedor extends CuentaendpointRequest<mx.jtails.provider.homelike.api.model.Proveedor> {
    ...
    protected GetClienteswithPedidoByProveedor() {
      super(Cuentaendpoint.this, "GET", REST_PATH, null, mx.jtails.provider.homelike.api.model.Proveedor.class);
    }
  ...
  public class GetCuenta extends CuentaendpointRequest<mx.jtails.provider.homelike.api.model.Cuenta> {
    ...
    protected GetCuenta(java.lang.Long id) {
      super(Cuentaendpoint.this, "GET", REST_PATH, null, mx.jtails.provider.homelike.api.model.Cuenta.class);
  ...
  public class GetCuentaByUser extends CuentaendpointRequest<mx.jtails.provider.homelike.api.model.Cuenta> {
   ...
   * operation.
   *
   * @param content the {@link mx.jtails.provider.homelike.api.model.Cuenta}
   * @return the request
   */
  public InsertCuenta insertCuenta(mx.jtails.provider.homelike.api.model.Cuenta content) throws java.io.IOException {
    InsertCuenta result = new InsertCuenta(content);
    initialize(result);
    return result;
  }

  public class InsertCuenta extends CuentaendpointRequest<mx.jtails.provider.homelike.api.model.Cuenta> {
     ...
     * @since 1.13
     */
    protected InsertCuenta(mx.jtails.provider.homelike.api.model.Cuenta content) {
      super(Cuentaendpoint.this, "POST", REST_PATH, content, mx.jtails.provider.homelike.api.model.Cuenta.class);
    }
  ...
  public class ListClientesinRange extends CuentaendpointRequest<mx.jtails.provider.homelike.api.model.CuentaCollection> {
    ...
    protected ListClientesinRange() {
      super(Cuentaendpoint.this, "GET", REST_PATH, null, mx.jtails.provider.homelike.api.model.CuentaCollection.class);
    }

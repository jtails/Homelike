package mx.jtails.provider.homelike.model;
...
public class HomelikeDatabase extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "homelike.provider.db";

    private static final int VER_2014_RELEASE_A = 101;

...
public class Proveedorendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getProveedorByUser".
   *
   * This request holds the parameters needed by the the proveedorendpoint server.  After setting any
   * optional parameters, call the {@link GetProveedorByUser#execute()} method to invoke the remote
   * operation.
   *
   * @param content the {@link mx.jtails.provider.homelike.api.model.Proveedor}
   * @return the request
   */
  public GetProveedorByUser getProveedorByUser(mx.jtails.provider.homelike.api.model.Proveedor content) throws java.io.IOException {
    GetProveedorByUser result = new GetProveedorByUser(content);
    initialize(result);
    return result;
  }

  public class GetProveedorByUser extends ProveedorendpointRequest<mx.jtails.provider.homelike.api.model.Proveedor> {

    private static final String REST_PATH = "getProveedorByUser";

    /**
     * Create a request for the method "getProveedorByUser".
     *
     * This request holds the parameters needed by the the proveedorendpoint server.  After setting
     * any optional parameters, call the {@link GetProveedorByUser#execute()} method to invoke the
     * remote operation. <p> {@link GetProveedorByUser#initialize(com.google.api.client.googleapis.ser
     ...
     * @since 1.13
     */
    protected GetProveedorByUser(mx.jtails.provider.homelike.api.model.Proveedor content) {
      super(Proveedorendpoint.this, "POST", REST_PATH, content, mx.jtails.provider.homelike.api.model.Proveedor.class);
    }

    @Override
    public GetProveedorByUser setAlt(java.lang.String alt) {
      return (GetProveedorByUser) super.setAlt(alt);
    }

    @Override
    public GetProveedorByUser setFields(java.lang.String fields) {
      return (GetProveedorByUser) super.setFields(fields);
    }

    @Override
    public GetProveedorByUser setKey(java.lang.String key) {
      return (GetProveedorByUser) super.setKey(key);
    }

    @Override
    public GetProveedorByUser setOauthToken(java.lang.String oauthToken) {
      return (GetProveedorByUser) super.setOauthToken(oauthToken);
    }

    @Override
    public GetProveedorByUser setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetProveedorByUser) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetProveedorByUser setQuotaUser(java.lang.String quotaUser) {
      return (GetProveedorByUser) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetProveedorByUser setUserIp(java.lang.String userIp) {
      return (GetProveedorByUser) super.setUserIp(userIp);
    }

    @Override
    public GetProveedorByUser set(String parameterName, Object value) {
      return (GetProveedorByUser) super.set(parameterName, value);
    }
  }

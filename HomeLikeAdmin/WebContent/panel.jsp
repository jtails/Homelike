...
<script src="js/homelike/panel.js"></script>
...
<body>
 ...
 <jsp:include page="fragments/session.jsp"/>
	...
	<div class="content">
		...
		<div class="sidebar">
			...
			<ul id="nav">
            	...
            	<li class="has_sub"><a href="#" id="menuproveedores"><i
						class="fa fa-group"></i> Proveedores</a>
				</li>
			</ul>
		</div>
		...
		<div class="mainbar" id="contenido">
			<jsp:include page="fragments/proveedores.jsp"/>
		</div>

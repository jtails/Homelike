...
function addRow(style,proveedor){
	...
	if(proveedor.status==0)
		status="<td class='  sorting_1'>PENDIENTE ACTIVACION</td>";
	if(proveedor.status==1)
		status="<td class='  sorting_1'>ACTIVO</td>";
	$("#tblProveedores").append(
		"<tr class='"+style+"' id='p"+proveedor.idProveedor+"' style='cursor: pointer'>"+
			"<td class='  sorting_1'>"+proveedor.idProveedor+"</td>"+
			"<td class='  sorting_1'><img src='"+proveedor.logo+"' class='img-circle' style='width:35px;height:35px'/></td>"+
